...
import 'package:final_app/ui/views/home/widget/components/search_field.dart';
import 'package:final_app/ui/views/page2/widget/widget_child/DialogWidgetTL.dart';
import 'package:final_app/ui/views/page2/widget/widget_child/tt_vanban/DialogWidgetTL.dart';
        ...
        children: [
          ...
          InkWell(
            onTap: () {
              showDialog(
                context: context,
                builder: (context) => const DialogWidgetTL(),
              );
            },
            child: Container(
          ...
          CustomButton(
              ...
              onPressed: () {
                showDialog(
                  context: context,
                  builder: (context) => const DialogWidgetTL1(),
                );
              }),
          horizontalSpaceSmall,
          CustomButton(
